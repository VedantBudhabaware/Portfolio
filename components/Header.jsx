...
const Header = () => {
    return (
        ...
        className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Vedant Budhabaware <Image src={assets.hand_icon} alt='' className='w-6' /></motion.h3>
        <motion.h1 
        ...
        className='max-w-2xl mx-auto font-Ovo'>
            I am a full-stack web developer with expertise in creating dynamic and responsive web applications. With a strong foundation in both front-end and back-end technologies.
        </motion.p>
